        ...
        <div class="row">
            ...
            <div class="col-sm-8 text-right with-mt">
                <span toggle_block="firms_groups_block">
                    ...
                    <span class="<?=Text::BTN?> btn-outline-success m-b-5" toggle="firms_groups_block"><i class="fa fa-pen"></i></span>
                </span>
...
<div class="card-body border-bottom d-lg-none bg-white">
    <div class="row">
        <div class="col-12">
            <span class="<?=Text::BTN?> btn-info" toggle_class="firms_groups_list">
                ...
                <?foreach($firmsGroups as $key => $group){?>
                    <li class="nav-item" tab="firms_group_<?=$group['GROUP_ID']?>">
                        ...
                        <span class="check_span_hidden">
                            ...
                            <span class="<?=Text::BTN?> btn-outline-success btn-sm" onclick="showEditFirmsGroupPopup(<?=$group['GROUP_ID']?>, event)"><i class="fa fa-pen"></i></span>
                        </span>
