        ...
        <div class="row">
            ...
            <div class="col-sm-8 text-right with-mt">
                <span toggle_block="dots_groups_block">
                    ...
                    <span class="<?=Text::BTN?> btn-success m-b-5" onclick="groupDotsToXls()"><i class="fa fa-file-excel"></i> Выгрузить</span>
                    <span class="<?=Text::BTN?> btn-outline-primary m-b-5" toggle="dots_groups_block"><i class="fa fa-pen"></i></span>
                </span>

                <span toggle_block="dots_groups_block" class="dn action_del">
                    <span class="<?=Text::BTN?> btn-danger btn_del_dots m-b-5"><i class="fa fa-trash-alt"></i> Удалить выделенные точки</span>
                    <span class="<?=Text::BTN?> btn-danger m-b-5" toggle="dots_groups_block"><i class="fa fa-times"></i></span>
                </span>
            </div>
        </div>
    </div>
...
<div class="card-body border-bottom d-lg-none bg-white">
    <div class="row">
        <div class="col-12">
            <span class="<?=Text::BTN?> btn-outline-info" toggle_class="dots_groups_list">
                ...
                <?foreach($dotsGroups as $key => $group){?>
                    <li class="nav-item" tab="dots_group_<?=$group['GROUP_ID']?>">
                        ...
                        <span class="check_span_hidden">
                            ...
                            <span class="<?=Text::BTN?> btn-danger btn-sm" onclick="deleteDotsGroup(<?=$group['GROUP_ID']?>, event)"><i class="fa fa-trash-alt"></i></span>
                            <span class="<?=Text::BTN?> btn-outline-primary btn-sm" onclick="showEditDotsGroupPopup(<?=$group['GROUP_ID']?>, event)"><i class="fa fa-pen"></i></span>
                        </span>
