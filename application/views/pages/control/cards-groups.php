    ...
    <div class="tab_content_header">
        <div class="fr">
            <span toggle_block="cards_groups_block">
                <a href="#control_add_cards_group" class="btn waves-effect waves-lightfancy"><i class="fa fa-plus"></i> Добавить группу</a>
                <a href="#control_add_cards" class="btn waves-effect waves-lightfancy"><i class="fa fa-plus"></i> Добавить карты</a>
