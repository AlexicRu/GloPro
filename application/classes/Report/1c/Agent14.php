 ...
 * Modul
 */
class Report_1c_Agent14 extends Report_1c_Common
{
    protected static $_agentId = 14;
    ...
    public function getDataForExport($params)
    {
        ...
        $sql = (new Builder())
            ->select([
                '(case
  when v.contract_id in (1444, 4830) then 1444 
                ...
                'decode(v.supplier_contract, 33, 20, decode(pi.country_id, 643, 20, 0)) as vat_rate',
                '0 as recharge_vat',
