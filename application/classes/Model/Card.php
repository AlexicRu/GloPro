...
class Model_Card extends Model
{
    ...
    public static function transferCards($oldContractId, $newContractId, $cards = [], $params = [])
    {
        ...
        $data = [
            ...
            'p_date_change'         => !empty($params['date_from']) ? Date::format($params['date_from']) : date('d.m.Y'),
            'p_date_last_trz'       => !empty($params['date_to']) ? Date::format($params['date_to']) : Date::DATE_MAX,
